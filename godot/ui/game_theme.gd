...
static func create() -> Theme:
	...
	result.set_stylebox("normal", "Button", _box(BLUE, Color("#0d4051"), 2, 7))
	result.set_stylebox("hover", "Button", _box(Color("#21809a"), GOLD, 2, 7))
	...
	result.set_stylebox("normal", "OptionButton", _box(BLUE, Color("#0d4051"), 2, 6))
	result.set_stylebox("hover", "OptionButton", _box(Color("#21809a"), GOLD, 2, 6))
