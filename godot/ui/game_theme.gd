...
static func create(palette: Dictionary = {}) -> Theme:
	...
	result.set_color("font_disabled_color", "Button", Color("#716a5e"))
	...
	result.set_stylebox("normal", "Button", _box(Color("#f3d995"), Color("#8e6a32"), 2, 7))
	result.set_stylebox("hover", "Button", _box(Color("#ffe9ad"), gold, 3, 7))
	result.set_stylebox("pressed", "Button", _box(Color("#ddb967"), Color("#fff0b8"), 2, 7))
	result.set_stylebox("disabled", "Button", _box(Color("#a9a18e"), Color("#756f62"), 2, 7))
	result.set_stylebox("focus", "Button", _box(Color(0, 0, 0, 0), Color("#ffe09a"), 2, 7))
	result.set_stylebox("normal", "OptionButton", _box(Color("#f3d995"), Color("#8e6a32"), 2, 6))
	result.set_stylebox("hover", "OptionButton", _box(Color("#ffe9ad"), gold, 2, 6))
