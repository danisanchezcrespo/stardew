...
func capture(game: Node2D) -> Dictionary:
	...
	for villager: Variant in game.villagers.values():
		villagers.append({"id": villager.stable_id, "name": villager.villager_name, "appearance": villager.appearance_id, "priority": villager.work_priority, "profession": villager.profession, "experience": villager.experience.duplicate(true), "inside_workplace": villager.inside_workplace, "schedule_hour":villager.last_schedule_hour, "home": villager.home_id, "home_position": [villager.home_position.x, villager.home_position.y], "position": [villager.position.x, villager.position.y], "hunger": villager.hunger, "energy": villager.energy, "happiness":villager.happiness, "state": villager.state, "facing": villager.facing, "task": villager.task.duplicate(true), "task_queue": villager.task_queue.duplicate(true), "carrying_item": villager.carrying_item, "carrying_amount": villager.carrying_amount, "tint": [villager.color_tint.r, villager.color_tint.g, villager.color_tint.b, villager.color_tint.a]})
